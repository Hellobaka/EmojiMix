...
using me.cqp.luohuaming.EmojiMix.Core;
using me.cqp.luohuaming.EmojiMix.Core.Domain;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp.Enum;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp.Interface;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp.Expand;
using me.cqp.luohuaming.EmojiMix.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.EmojiMix.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.EmojiMix";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.EmojiMix", 1, 9, "EmojiMix", "1.0.0", 1, "落花茗", "EmojiMix", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.EmojiMix", AppData.CQLog);	
