...
namespace PublicInfos
{
    public static class CommonHelper
    {
        ...
        public static bool IsEmojiCQCode(this string pattern) => Regex.IsMatch(pattern, "\\[CQ:emoji,id=(\\d*)\\]");
        public static string GetEmojiID(this string emoji) => Convert.ToInt32(Regex.Replace(emoji, "\\[CQ:emoji,id=(\\d*)\\]", "$1")).ToString("x0");
    }
}
